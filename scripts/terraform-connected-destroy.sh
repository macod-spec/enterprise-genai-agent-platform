...
readonly EXPECTED_SUBSCRIPTION="${AZURE_SUBSCRIPTION_ID:?Set AZURE_SUBSCRIPTION_ID to the approved target}"
readonly EXPECTED_TENANT="${AZURE_TENANT_ID:?Set AZURE_TENANT_ID to the approved target}"
