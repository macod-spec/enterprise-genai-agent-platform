...
| Model gateway — Azure OpenAI adapter | `UNVERIFIED` | Keyless `DefaultAzureCredential` adapter, same contract as the mock (ADR-006) | Unit/type-checked only | Never called a real Azure OpenAI endpoint |
