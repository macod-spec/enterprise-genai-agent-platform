...
| Delivery | Non-deploying GitHub Actions and signed local artifact contract, plus a complete but dormant publish/plan/apply/deploy pipeline (ADR-013) | `.github/workflows/ci.yaml`, `.github/workflows/container-publish.yaml`, `.github/workflows/terraform-plan.yaml`, `.github/workflows/terraform-apply.yaml`, `.github/workflows/deploy.yaml` | CD workflows are `actionlint`-clean and OIDC-based but not yet authenticated to Azure; see `docs/ci-cd-azure-setup.md` |
